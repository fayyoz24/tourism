...
# from users.views.club_manager import ClubSignupView
...
#     # url: /users/clubs/signup/ | name: users:club_signup
#     path('club/signup', ClubSignupView.as_view(), name='club_signup'),
]
